<link
      rel="shortcut icon"
      type="image/x-icon"
      href="{{asset('back_auth/asset/img/favicon.png')}}"
    />
    <link rel="stylesheet" href="{{asset('back_auth/asset/css/bootstrap.min.css')}}" />
    <link
      rel="stylesheet"
      href="{{asset('back_auth/asset/plugins/fontawesome/css/fontawesome.min.css')}}"
    />
    ...
    <link rel="stylesheet" href="{{asset('back_auth/asset/css/style.css')}}" />
